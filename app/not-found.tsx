  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      ...
      <div className="relative z-10 text-center max-w-md">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 rounded-full border border-[#FF7828]/25 bg-[#FF7828]/[0.08] px-4 py-1.5 mb-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-8">
          <Link href="/games">
            <Button className="h-11 px-6 rounded-full bg-[#FF7828] hover:bg-[#FFA550] text-white font-bold gap-2 shadow-[0_8px_24px_rgba(255,120,40,0.35)]">
          ...
          <Link href="/">
            <Button
              variant="ghost"
              className="h-11 px-5 rounded-full text-white/40 hover:text-white hover:bg-white/5 font-medium gap-2"
            >
