    ...
    <div className={`flex flex-col items-center gap-3 flex-1 ${side === "home" ? "items-end" : "items-start"}`}>
      <div className="relative">
        ...
        <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full overflow-hidden border border-[#0D1117]">
          <PlayerImg src={teamLogoUrl(teamId)} alt="" className="w-full h-full object-contain bg-white/5" />
        </div>
      </div>
      <div className={side === "home" ? "text-right" : ""}>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-[260px] sm:h-[320px] overflow-hidden">
        {stadiumUrl ? (
          ...
          <PlayerImg src={stadiumUrl} alt={game.venue.name} className="absolute inset-0 w-full h-full object-cover" />
        ) : (
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 pb-6 flex items-end justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <PlayerImg src={teamLogoUrl(away.team.id)} alt="" className="w-full h-full object-contain" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-12 h-12">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <PlayerImg src={teamLogoUrl(home.team.id)} alt="" className="w-full h-full object-contain" />
            </div>
          </div>
        </div>
      </div>
