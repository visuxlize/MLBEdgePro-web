...
function getOpponent(teamAbbr: string, matchup: string): string {
  const parts = matchup.split(" vs ");
  return parts[0] === teamAbbr ? (parts[1] ?? "OPP") : (parts[0] ?? "OPP");
}

const PROP_TEMPLATES: PropTemplate[] = [
  // EPL — Sep 21
  { id: "haaland",  playerName: "E. Haaland",    espnPlayerId: "4155882", teamId: "382", teamAbbr: "MCI", teamHex: "#6CABDD", position: "ST", league: "epl",        matchup: "MCI vs ARS", matchDate: "Sep 21",
  ...
  { id: "salah",    playerName: "M. Salah",       espnPlayerId: "167664",  teamId: "364", teamAbbr: "LIV", teamHex: "#C8102E", position: "MF", league: "epl",        matchup: "LIV vs CHE", matchDate: "Sep 21",
  ...
  { id: "saka",     playerName: "B. Saka",        espnPlayerId: "4318076", teamId: "359", teamAbbr: "ARS", teamHex: "#EF0107", position: "MF", league: "epl",        matchup: "MCI vs ARS", matchDate: "Sep 21",
  ...
  { id: "palmer",   playerName: "C. Palmer",      espnPlayerId: "4778011", teamId: "363", teamAbbr: "CHE", teamHex: "#034694", position: "MF", league: "epl",        matchup: "LIV vs CHE", matchDate: "Sep 21",
  ...
  // La Liga — Sep 20
  { id: "mbappe",   playerName: "K. Mbappé",      espnPlayerId: "4006310", teamId: "86",  teamAbbr: "RMA", teamHex: "#FEBE10", position: "ST", league: "laliga",     matchup: "RMA vs BAR", matchDate: "Sep 20",
  ...
  { id: "vini",     playerName: "Vinicius Jr.",    espnPlayerId: "4321877", teamId: "86",  teamAbbr: "RMA", teamHex: "#FEBE10", position: "MF", league: "laliga",     matchup: "RMA vs BAR", matchDate: "Sep 20",
  ...
  { id: "lewand",   playerName: "R. Lewandowski", espnPlayerId: "1995913", teamId: "83",  teamAbbr: "BAR", teamHex: "#A50044", position: "ST", league: "laliga",     matchup: "RMA vs BAR", matchDate: "Sep 20",
  ...
  // Serie A — Sep 22
  { id: "lautaro",  playerName: "L. Martínez",    espnPlayerId: "4154558", teamId: "110", teamAbbr: "INT", teamHex: "#0068A8", position: "ST", league: "seriea",     matchup: "INT vs JUV", matchDate: "Sep 22",
  ...
  { id: "leao",     playerName: "R. Leão",         espnPlayerId: "4273667", teamId: "103", teamAbbr: "MIL", teamHex: "#FB090B", position: "MF", league: "seriea",     matchup: "MIL vs ROM", matchDate: "Sep 22",
  ...
  // Bundesliga — Sep 20
  { id: "kane",     playerName: "H. Kane",         espnPlayerId: "156623",  teamId: "132", teamAbbr: "FCB", teamHex: "#DC052D", position: "ST", league: "bundesliga", matchup: "FCB vs BVB", matchDate: "Sep 20",
  ...
  { id: "guirassy", playerName: "S. Guirassy",     espnPlayerId: "4273669", teamId: "124", teamAbbr: "BVB", teamHex: "#FDE100", position: "ST", league: "bundesliga", matchup: "FCB vs BVB", matchDate: "Sep 20",
  ...
  // Ligue 1 — Sep 21
  { id: "barcola",  playerName: "B. Barcola",      espnPlayerId: "5091374", teamId: "160", teamAbbr: "PSG", teamHex: "#004170", position: "MF", league: "ligue1",     matchup: "PSG vs OLY", matchDate: "Sep 21",
  ...
  // MLS — Sep 22
  { id: "messi",    playerName: "L. Messi",        espnPlayerId: "45843",   teamId: "4156", teamAbbr: "MIA", teamHex: "#F7B5CD", position: "MF", league: "mls",        matchup: "MIA vs ATL", matchDate: "Sep 22",
  ...
  for (const t of templates) {
    for (const p of t.props) {
      ...
      props.push({
        ...
        opponent: getOpponent(t.teamAbbr, t.matchup),
