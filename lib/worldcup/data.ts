import type { HostCity, WCTeam, BracketState, BracketMatch, WCGroup } from "./types";
...
export const WC_TEAMS: Record<string, WCTeam> = {
  ...
  rsa: { id: "rsa", name: "South Africa",      shortName: "RSA", countryCode: "za", strength: 1548, color: "#007A4D" },
  cze: { id: "cze", name: "Czech Republic",    shortName: "CZE", countryCode: "cz", strength: 1658, color: "#D7141A" },
  bih: { id: "bih", name: "Bosnia & Herzegovina", shortName: "BIH", countryCode: "ba", strength: 1612, color: "#002395" },
  hai: { id: "hai", name: "Haiti",             shortName: "HAI", countryCode: "ht", strength: 1498, color: "#00209F" },
  tur: { id: "tur", name: "Turkey",            shortName: "TUR", countryCode: "tr", strength: 1672, color: "#E30A17" },
  civ: { id: "civ", name: "Ivory Coast",       shortName: "CIV", countryCode: "ci", strength: 1648, color: "#F77F00" },
  cur: { id: "cur", name: "Curaçao",           shortName: "CUR", countryCode: "cw", strength: 1528, color: "#003DA5" },
  swe: { id: "swe", name: "Sweden",            shortName: "SWE", countryCode: "se", strength: 1698, color: "#006AA7" },
  nzl: { id: "nzl", name: "New Zealand",       shortName: "NZL", countryCode: "nz", strength: 1518, color: "#00247D" },
  cpv: { id: "cpv", name: "Cape Verde",        shortName: "CPV", countryCode: "cv", strength: 1568, color: "#003893" },
  irq: { id: "irq", name: "Iraq",              shortName: "IRQ", countryCode: "iq", strength: 1582, color: "#007A3D" },
  nor: { id: "nor", name: "Norway",            shortName: "NOR", countryCode: "no", strength: 1668, color: "#EF2B2D" },
  alg: { id: "alg", name: "Algeria",           shortName: "ALG", countryCode: "dz", strength: 1632, color: "#006233" },
  jor: { id: "jor", name: "Jordan",            shortName: "JOR", countryCode: "jo", strength: 1548, color: "#007A3D" },
  uzb: { id: "uzb", name: "Uzbekistan",        shortName: "UZB", countryCode: "uz", strength: 1578, color: "#1EB53A" },
  cod: { id: "cod", name: "DR Congo",          shortName: "COD", countryCode: "cd", strength: 1598, color: "#007FFF" },
};
...
export const INITIAL_BRACKET: BracketState = {
  ...
  matches: {
    // ── Round of 32 — teams TBD (group stage still in progress) ─────────────
    r32_0:  match("r32_0",  "r32", 0, "upper", null, null, "r16_0", "top",    "Jul 1",  "18:00","MetLife Stadium",    "New York"),
    r32_1:  match("r32_1",  "r32", 1, "upper", null, null, "r16_0", "bottom", "Jul 1",  "21:00","SoFi Stadium",       "Los Angeles"),
    r32_2:  match("r32_2",  "r32", 2, "upper", null, null, "r16_1", "top",    "Jul 2",  "18:00","Gillette Stadium",   "Boston"),
    r32_3:  match("r32_3",  "r32", 3, "upper", null, null, "r16_1", "bottom", "Jul 2",  "21:00","Lumen Field",        "Seattle"),
    r32_4:  match("r32_4",  "r32", 4, "upper", null, null, "r16_2", "top",    "Jul 3",  "18:00","AT&T Stadium",       "Dallas"),
    r32_5:  match("r32_5",  "r32", 5, "upper", null, null, "r16_2", "bottom", "Jul 3",  "21:00","Hard Rock Stadium",  "Miami"),
    r32_6:  match("r32_6",  "r32", 6, "upper", null, null, "r16_3", "top",    "Jul 4",  "18:00","Levi's Stadium",     "Bay Area"),
    r32_7:  match("r32_7",  "r32", 7, "upper", null, null, "r16_3", "bottom", "Jul 4",  "21:00","Estadio Azteca",     "Mexico City"),
    // ── Round of 32 — Lower bracket ──────────────────────────────────────────
    r32_8:  match("r32_8",  "r32", 8, "lower", null, null, "r16_4", "top",    "Jul 5",  "18:00","NRG Stadium",        "Houston"),
    r32_9:  match("r32_9",  "r32", 9, "lower", null, null, "r16_4", "bottom", "Jul 5",  "21:00","Arrowhead Stadium",  "Kansas City"),
    r32_10: match("r32_10", "r32",10, "lower", null, null, "r16_5", "top",    "Jul 6",  "18:00","BMO Field",          "Toronto"),
    r32_11: match("r32_11", "r32",11, "lower", null, null, "r16_5", "bottom", "Jul 6",  "21:00","BC Place",           "Vancouver"),
    r32_12: match("r32_12", "r32",12, "lower", null, null, "r16_6", "top",    "Jul 7",  "18:00","Lincoln Financial",  "Philadelphia"),
    r32_13: match("r32_13", "r32",13, "lower", null, null, "r16_6", "bottom", "Jul 7",  "21:00","Estadio Akron",      "Guadalajara"),
    r32_14: match("r32_14", "r32",14, "lower", null, null, "r16_7", "top",    "Jul 8",  "18:00","Estadio BBVA",       "Monterrey"),
    r32_15: match("r32_15", "r32",15, "lower", null, null, "r16_7", "bottom", "Jul 8",  "21:00","Mercedes-Benz Std.", "Atlanta"),
    // ── Round of 16 — Upper ──────────────────────────────────────────────────
...
export const WC_GROUPS: WCGroup[] = [
  {
    id: "A",
    teams: [
      { teamId: "mex", p: 1, w: 1, d: 0, l: 0, gf: 2, ga: 0, pts: 3 },
      { teamId: "kor", p: 1, w: 1, d: 0, l: 0, gf: 2, ga: 1, pts: 3 },
      { teamId: "cze", p: 1, w: 0, d: 0, l: 1, gf: 1, ga: 2, pts: 0 },
      { teamId: "rsa", p: 1, w: 0, d: 0, l: 1, gf: 0, ga: 2, pts: 0 },
    ],
    matches: [
      { home: "mex", away: "rsa", date: "Jun 11", time: "6:00 PM", venue: "SoFi Stadium, LA",
        homeScore: 2, awayScore: 0, status: "completed",
        goals: [
          { teamId: "mex", scorer: "J. Quiñones", min: 9 },
          { teamId: "mex", scorer: "R. Jiménez", min: 67 },
        ]},
      { home: "kor", away: "cze", date: "Jun 11", time: "9:00 PM", venue: "Levi's Stadium, Bay Area",
        homeScore: 2, awayScore: 1, status: "completed",
        goals: [
          { teamId: "cze", scorer: "L. Krejčí", min: 59 },
          { teamId: "kor", scorer: "Hwang In-beom", min: 67 },
          { teamId: "kor", scorer: "Oh Hyeon-gyu", min: 80 },
        ]},
      { home: "rsa", away: "kor", date: "Jun 17", time: "3:00 PM", venue: "BC Place, Vancouver",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "cze", away: "mex", date: "Jun 17", time: "6:00 PM", venue: "Estadio Akron, Guadalajara",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "rsa", away: "cze", date: "Jun 24", time: "3:00 PM", venue: "AT&T Stadium, Dallas",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "mex", away: "kor", date: "Jun 24", time: "3:00 PM", venue: "SoFi Stadium, LA",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
    ],
  },
  {
    ...
    matches: [
      ...
      { home: "sui", away: "bih", date: "Jun 18", time: "3:00 PM", venue: "SoFi Stadium, LA",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "can", away: "qat", date: "Jun 18", time: "6:00 PM", venue: "BC Place, Vancouver",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "bih", away: "qat", date: "Jun 24", time: "3:00 PM", venue: "Lumen Field, Seattle",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "sui", away: "can", date: "Jun 24", time: "3:00 PM", venue: "BC Place, Vancouver",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
    ],
  },
  {
    id: "C",
    teams: [
      { teamId: "bra", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "mor", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "sco", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "hai", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
    ],
    matches: [
      { home: "bra", away: "mor", date: "Jun 13", time: "6:00 PM", venue: "MetLife Stadium, New York",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "hai", away: "sco", date: "Jun 13", time: "9:00 PM", venue: "Gillette Stadium, Boston",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "mor", away: "sco", date: "Jun 19", time: "3:00 PM", venue: "Lincoln Financial, Philadelphia",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "bra", away: "hai", date: "Jun 19", time: "6:00 PM", venue: "Hard Rock Stadium, Miami",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "sco", away: "bra", date: "Jun 24", time: "3:00 PM", venue: "Mercedes-Benz Stadium, Atlanta",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "mor", away: "hai", date: "Jun 24", time: "3:00 PM", venue: "MetLife Stadium, New York",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
    ],
  },
  {
    ...
    matches: [
      ...
      { home: "usa", away: "aus", date: "Jun 19", time: "6:00 PM", venue: "Lumen Field, Seattle",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "tur", away: "par", date: "Jun 19", time: "9:00 PM", venue: "Levi's Stadium, Bay Area",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "tur", away: "usa", date: "Jun 25", time: "6:00 PM", venue: "SoFi Stadium, LA",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "par", away: "aus", date: "Jun 25", time: "6:00 PM", venue: "Levi's Stadium, Bay Area",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
    ],
  },
  {
    id: "E",
    teams: [
      { teamId: "ger", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "ecu", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "civ", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "cur", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
    ],
    matches: [
      { home: "ger", away: "cur", date: "Jun 14", time: "6:00 PM", venue: "AT&T Stadium, Dallas",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "civ", away: "ecu", date: "Jun 14", time: "9:00 PM", venue: "NRG Stadium, Houston",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "ger", away: "civ", date: "Jun 20", time: "6:00 PM", venue: "AT&T Stadium, Dallas",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "ecu", away: "cur", date: "Jun 20", time: "9:00 PM", venue: "Arrowhead Stadium, Kansas City",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "cur", away: "civ", date: "Jun 25", time: "6:00 PM", venue: "Hard Rock Stadium, Miami",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "ecu", away: "ger", date: "Jun 25", time: "6:00 PM", venue: "NRG Stadium, Houston",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
    ],
  },
  {
    id: "F",
    teams: [
      { teamId: "ned", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "jpn", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "swe", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "tun", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
    ],
    matches: [
      { home: "ned", away: "jpn", date: "Jun 14", time: "3:00 PM", venue: "Lincoln Financial, Philadelphia",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "swe", away: "tun", date: "Jun 14", time: "6:00 PM", venue: "Lumen Field, Seattle",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "ned", away: "swe", date: "Jun 20", time: "3:00 PM", venue: "MetLife Stadium, New York",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "tun", away: "jpn", date: "Jun 20", time: "9:00 PM", venue: "Estadio BBVA, Monterrey",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "jpn", away: "swe", date: "Jun 25", time: "3:00 PM", venue: "Gillette Stadium, Boston",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "tun", away: "ned", date: "Jun 25", time: "3:00 PM", venue: "SoFi Stadium, LA",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
    ],
  },
  {
    id: "G",
    teams: [
      { teamId: "bel", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "irn", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "egy", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "nzl", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
    ],
    matches: [
      { home: "bel", away: "egy", date: "Jun 15", time: "6:00 PM", venue: "Levi's Stadium, Bay Area",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "irn", away: "nzl", date: "Jun 15", time: "9:00 PM", venue: "SoFi Stadium, LA",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "bel", away: "irn", date: "Jun 21", time: "6:00 PM", venue: "BC Place, Vancouver",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "nzl", away: "egy", date: "Jun 21", time: "9:00 PM", venue: "Lumen Field, Seattle",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "egy", away: "irn", date: "Jun 26", time: "3:00 PM", venue: "Gillette Stadium, Boston",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "nzl", away: "bel", date: "Jun 26", time: "3:00 PM", venue: "AT&T Stadium, Dallas",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
    ],
  },
  {
    id: "H",
    teams: [
      { teamId: "esp", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "uru", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "ksa", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "cpv", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
    ],
    matches: [
      { home: "esp", away: "cpv", date: "Jun 15", time: "3:00 PM", venue: "MetLife Stadium, New York",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "ksa", away: "uru", date: "Jun 15", time: "6:00 PM", venue: "Hard Rock Stadium, Miami",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "esp", away: "ksa", date: "Jun 21", time: "3:00 PM", venue: "NRG Stadium, Houston",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "uru", away: "cpv", date: "Jun 21", time: "6:00 PM", venue: "Arrowhead Stadium, Kansas City",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "cpv", away: "ksa", date: "Jun 26", time: "3:00 PM", venue: "Estadio Azteca, Mexico City",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "uru", away: "esp", date: "Jun 26", time: "3:00 PM", venue: "AT&T Stadium, Dallas",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
    ],
  },
  {
    id: "I",
    teams: [
      { teamId: "fra", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "sen", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "nor", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "irq", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
    ],
    matches: [
      { home: "fra", away: "sen", date: "Jun 16", time: "6:00 PM", venue: "MetLife Stadium, New York",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "irq", away: "nor", date: "Jun 16", time: "9:00 PM", venue: "Arrowhead Stadium, Kansas City",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "fra", away: "irq", date: "Jun 22", time: "6:00 PM", venue: "Gillette Stadium, Boston",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "nor", away: "sen", date: "Jun 22", time: "9:00 PM", venue: "Lumen Field, Seattle",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "nor", away: "fra", date: "Jun 26", time: "6:00 PM", venue: "Hard Rock Stadium, Miami",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "sen", away: "irq", date: "Jun 26", time: "6:00 PM", venue: "Lincoln Financial, Philadelphia",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
    ],
  },
  {
    id: "J",
    teams: [
      { teamId: "arg", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "aut", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "alg", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "jor", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
    ],
    matches: [
      { home: "arg", away: "alg", date: "Jun 16", time: "3:00 PM", venue: "Arrowhead Stadium, Kansas City",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "aut", away: "jor", date: "Jun 16", time: "6:00 PM", venue: "Levi's Stadium, Bay Area",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "arg", away: "aut", date: "Jun 22", time: "3:00 PM", venue: "AT&T Stadium, Dallas",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "jor", away: "alg", date: "Jun 22", time: "6:00 PM", venue: "Levi's Stadium, Bay Area",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "alg", away: "aut", date: "Jun 27", time: "3:00 PM", venue: "Arrowhead Stadium, Kansas City",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "jor", away: "arg", date: "Jun 27", time: "3:00 PM", venue: "AT&T Stadium, Dallas",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
    ],
  },
  {
    id: "K",
    teams: [
      { teamId: "por", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "col", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "uzb", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "cod", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
    ],
    matches: [
      { home: "por", away: "uzb", date: "Jun 17", time: "6:00 PM", venue: "Hard Rock Stadium, Miami",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "col", away: "cod", date: "Jun 17", time: "9:00 PM", venue: "Mercedes-Benz Stadium, Atlanta",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "por", away: "col", date: "Jun 23", time: "3:00 PM", venue: "NRG Stadium, Houston",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "cod", away: "uzb", date: "Jun 23", time: "6:00 PM", venue: "Arrowhead Stadium, Kansas City",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "uzb", away: "col", date: "Jun 27", time: "6:00 PM", venue: "Lincoln Financial, Philadelphia",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "cod", away: "por", date: "Jun 27", time: "6:00 PM", venue: "Hard Rock Stadium, Miami",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
    ],
  },
  {
    id: "L",
    teams: [
      { teamId: "eng", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "cro", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "gha", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
      { teamId: "pan", p: 0, w: 0, d: 0, l: 0, gf: 0, ga: 0, pts: 0 },
    ],
    matches: [
      { home: "eng", away: "cro", date: "Jun 17", time: "3:00 PM", venue: "AT&T Stadium, Dallas",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "gha", away: "pan", date: "Jun 17", time: "6:00 PM", venue: "BMO Field, Toronto",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "eng", away: "gha", date: "Jun 23", time: "6:00 PM", venue: "Gillette Stadium, Boston",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "pan", away: "cro", date: "Jun 23", time: "9:00 PM", venue: "BMO Field, Toronto",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "pan", away: "eng", date: "Jun 27", time: "6:00 PM", venue: "MetLife Stadium, New York",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
      { home: "cro", away: "gha", date: "Jun 27", time: "6:00 PM", venue: "Lincoln Financial, Philadelphia",
        homeScore: null, awayScore: null, status: "scheduled", goals: [] },
    ],
  },
];
